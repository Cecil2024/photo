    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-sm">
        <div className="container flex h-16 items-center justify-between">
          <h1 className="text-lg font-light tracking-[0.1em] pl-8">Wedding Brochure</h1>
          <MainNav />
        </div>
      </header>
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        <div className="rounded-lg overflow-hidden shadow-lg">
          <iframe
            src="/wedding-prices.pdf#toolbar=1&navpanes=0&scrollbar=1"
            className="w-full"
            style={{ height: 'calc(100vh - 150px)' }}
            title="Wedding Photography Brochure"
          />
        </div>
